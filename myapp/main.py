...
def get_Start_N_End_Time():
    ...
    startTime = datetime.datetime(int(file_name),mm,1,0,0)  # start time of plot
...
layout = column(p,select,row(month_dropdown,var_menu))
